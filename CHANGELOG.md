...
## [1.3.1-beta.3] - 2026-08-12

### 修复

- 修复评论折叠预览在部分自动换行或富文本布局中内容已截断但不显示省略号的问题。

## [1.3.1-beta.2] - 2026-08-09

### 修复

- 修复评论折叠使用原始文字测量、富文本绘制时换行位置不一致，导致空行边界仍可能截断但不显示省略号的问题。

## [1.3.1-beta.1] - 2026-08-07
