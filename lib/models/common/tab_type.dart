...
extension TabTypeDesc on TabType {
  String get description => ['直播', '推荐', '热门', '分区', '影视'][index];
...
List tabsConfig = [
  ...
  {
    'icon': const Icon(Icons.thumb_up_off_alt_outlined, size: 15),
    'label': '推荐',
    'type': TabType.rcmd,
  ...
  {
    'icon': const Icon(Icons.whatshot_outlined, size: 15),
    'label': '热门',
    'type': TabType.hot,
  ...
  {
    'icon': const Icon(Icons.play_circle_outlined, size: 15),
    'label': '影视',
