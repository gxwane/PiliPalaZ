    ...
    return Column(
      children: [
        ...
        RepaintBoundary(
          key: globalKey,
          child: Obx(() {
            if (_loginPageCtr.codeInfo.value?.payload['url'] == null) {
              return const SizedBox(
                height: 200,
                width: 200,
                child: Center(
                  child: CircularProgressIndicator(semanticsLabel: '二维码加载中'),
                ),
              );
            }
            ...
            return QrImageView(
              ...
              data: _loginPageCtr.codeInfo.value!.payload['url'] as String,
              size: 200,
              semanticsLabel: '二维码',
            );
          }),
          ...
          () => GestureDetector(
            onTap: () {
              ...
              Clipboard.setData(
                ClipboardData(
                  text:
                      _loginPageCtr.codeInfo.value?.payload['url'] as String? ??
                      "",
                ),
              );
  ...
  Widget tabViewOuter(child) {
    return SingleChildScrollView(
      child: Align(
        ...
        child: SizedBox(height: 500, width: 600, child: child),
      ),
    );
  }
}
