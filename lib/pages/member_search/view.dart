...
class _MemberSearchPageState extends State<MemberSearchPage>
  ...
  final MemberSearchController _memberSearchCtr = Get.put(
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        return CustomScrollView(
          ...
          slivers: <Widget>[
            FutureBuilder<ApiResult<MemberArchiveDataModel>?>(
              future: _memberSearchCtr.searchArchives(),
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.done &&
                    snapshot.hasData) {
                  final result = snapshot.data!;
                  if (result is ApiSuccess<MemberArchiveDataModel>) {
                    return SliverPadding(
                      ...
                      sliver: Obx(
                        () => _memberSearchCtr.archiveList.isNotEmpty
                            ? SliverGrid(
                                ...
                                delegate: SliverChildBuilderDelegate(
                                  (context, index) {
                                    return VideoCardH(
                                      videoItem:
                                          _memberSearchCtr.archiveList[index],
                                    );
                                  },
                                  childCount:
                            ...
                            : _memberSearchCtr.loadingStatus.value == 'loading'
                            ? SliverGrid(
                                gridDelegate:
                                    SliverGridDelegateWithExtentAndRatio(
                    ...
                    return HttpError(
                      errMsg: (result as ApiFailure<MemberArchiveDataModel>)
                          .message,
                      fn: () => setState(() {}),
                    );
                  }
