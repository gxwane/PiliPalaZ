...
class _MemberSeasonPageState extends State<MemberSeasonPage> {
  final MemberSeasonController _memberSeasonController = Get.put(
    MemberSeasonController(),
  );
  late Future<ApiResult<MemberSeasonsList>> _futureBuilderFuture;
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          ...
          child: FutureBuilder<ApiResult<MemberSeasonsList>>(
            ...
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.done) {
                if (snapshot.data != null) {
                  ...
                  if (result is ApiSuccess<MemberSeasonsList>) {
                    return Obx(
                      () => list.isNotEmpty
                          ? LayoutBuilder(
                    ...
                    return Text(
                      (result as ApiFailure<MemberSeasonsList>).message,
                    );
                  }
                } else {
