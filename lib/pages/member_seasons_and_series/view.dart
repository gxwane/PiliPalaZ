...
class _MemberSeasonsAndSeriesPageState
  ...
  late Future<ApiResult<MemberSeasonsAndSeriesDataModel>> _futureBuilderFuture;
    ...
    return NotificationListener<ScrollNotification>(
      ...
      child: RefreshIndicator(
        ...
        child: CustomScrollView(
          ...
          slivers: [
            FutureBuilder<ApiResult<MemberSeasonsAndSeriesDataModel>>(
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.done) {
                  ...
                  if (result is ApiSuccess<MemberSeasonsAndSeriesDataModel>) {
                    ...
                    // 请求错误
                    return commonWidget(
                      (result as ApiFailure<MemberSeasonsAndSeriesDataModel>)
                          .message,
                    );
                  }
                } else {
